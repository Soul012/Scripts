...
salt="11d5279b0908e44fc8fa7e3f0076941eaYWABServer"
dts=$(date +%s)
at=$(echo -n $guid$qrsn$salt$dts | md5sum | cut -d " " -f1)
bd=$(curl -s "https://ywab.reader.qq.com/user/experiments/v2?property=1&qrsn_new=$qrsn&guid=$guid&version=qqreader_7.7.7.0900_android&timestamp=$dts&appId=1&appToken=$at&qimei=$qrsn&channel=10001899")
}
ye(){
